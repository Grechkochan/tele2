...
REASONS = [
    "1. Антенно-фидерное уст-во Объекта",
    "2. Оборудование Объекта",
    "3. Работы по ант.-фидерному устройству РРЛ",
    "4. Работы по оборудованию РРЛ и трансмиссии",
    "5. Работы по энергопринимающему устройству",
    "6. Общестроительные работы",
    "7. Помещения Объекта",
    "8. Охранно-пожарная сигнализация",
    "9. Драйв-тесты (радиоизмерения)",
    "10. Иные Работы",
    "Тех. обслуживание",
    "Иное",
